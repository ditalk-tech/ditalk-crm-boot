package org.dromara.module.lead.domain.bo;
...
@AutoMapper(target = LeadInfo.class, reverseConvertGenerate = false)
public class LeadInfoBo extends BaseEntity {
